...
export default function HomePage({ params }: { params: { locale: string } }) {
  ...
  const trust = [
    { icon: <Shield size={22} className="text-lime-600" />, label: t.home.trust.safety, sub: t.home.trust.safetySub },
    { icon: <Star size={22} className="text-lime-500" />, label: t.home.trust.rated, sub: t.home.trust.ratedSub },
    { icon: <Clock size={22} className="text-lime-600" />, label: t.home.trust.flexible, sub: t.home.trust.flexibleSub },
    { icon: <Users size={22} className="text-lime-500" />, label: t.home.trust.local, sub: t.home.trust.localSub },
  ]

  return (
    <>
      {/* Hero */}
      <section className="relative min-h-[90vh] flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 overflow-hidden">
        <Image
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 text-center text-white">
          <span className="inline-block bg-lime-500 text-white text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
            {t.home.badge}
          </span>
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight mb-6">
            {t.home.heroTitle1} <span className="text-lime-500">{t.home.heroTitle2}</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href={`/${locale}/tours`}
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-lime-500 hover:bg-lime-600 text-white font-bold rounded-xl text-lg transition-colors shadow-lg"
            >
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-10">
            <Link
              href={`/${locale}/tours`}
              className="inline-flex items-center gap-2 px-6 py-3 border-2 border-lime-600 text-lime-700 hover:bg-lime-600 hover:text-white font-semibold rounded-lg transition-colors"
            >
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="text-lime-500 font-semibold text-sm uppercase tracking-wider">{t.home.whyUs}</span>
            ...
            <Link
              href={`/${locale}/about`}
              className="inline-flex items-center gap-2 mt-8 px-6 py-3 bg-lime-600 hover:bg-gray-900 text-white font-semibold rounded-lg transition-colors"
            >
      ...
      {/* CTA Banner */}
      <section className="bg-gradient-to-r from-gray-900 to-black py-14 px-4 text-white text-center">
